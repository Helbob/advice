        ...
        <div className="container">
          ...
          <form className="text">
            <div className="form-control">
              <label htmlFor="social-media">Which is your perfered social media platform?</label>
              <select onChange={handleCalc} ref={selectMedia}>
                <option value="chose">Select social media...</option>
            ...
            <div className="form-control">
              <label htmlFor="input-number">How many hours a day do you use it?</label>
              <input placeholder="Choose hours..."
                required
                type="number"
                name="number"
                id="input-number"
